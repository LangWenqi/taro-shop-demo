...
QR8bitByte.prototype = {
  ...
  for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
    var u = e[s].dataCount,
      h = e[s].totalCount - u;
    o = Math.max(o, u), n = Math.max(n, h), i[s] = new Array(u);
  ...
  var c = new Array(d),
    Q = 0;
  for (l = 0; l < o; l++)
    for (s = 0; s < e.length; s++) l < i[s].length && (c[Q++] = i[s][l]);
  for (l = 0; l < n; l++)
    for (s = 0; s < e.length; s++) l < a[s].length && (c[Q++] = a[s][l]);
  return c
};
for (var QRMode = {
    MODE_NUMBER: 1,
...
function drawQrcode(t) {
  ...
  t = t || {}, (t = Object.assign({
    ...
    for (var r = t._this ? wx.createCanvasContext && wx.createCanvasContext(t.canvasId, t._this) : wx.createCanvasContext && wx.createCanvasContext(t.canvasId), o = t.width / e.getModuleCount(), n = t.height / e.getModuleCount(), i = 0; i < e.getModuleCount(); i++)
      for (var a = 0; a < e.getModuleCount(); a++) {
        var s = e.isDark(i, a) ? t.foreground : t.background;
        r.setFillStyle(s);
        var u = Math.ceil((a + 1) * o) - Math.floor(a * o),
          h = Math.ceil((i + 1) * o) - Math.floor(i * o);
        r.fillRect(Math.round(a * o), Math.round(i * n), u, h)
      }
    r.draw(!1, function (e) {
...
QRPolynomial.prototype = {
  ...
  for (var o = r.length / 3, n = new Array, i = 0; i < o; i++)
    for (var a = r[3 * i + 0], s = r[3 * i + 1], u = r[3 * i + 2], h = 0; h < a; h++) n.push(new QRRSBlock(s, u));
  return n
